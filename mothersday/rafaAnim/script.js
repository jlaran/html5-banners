...
function frame3() {
  ...
  TweenMax.to("#device2", 1, {top:40, left:-25, scaleX:0.65, scaleY:0.92, rotationY:135, ease:Power4.easeOut, transformOrigin:"right bottom", delay:8, onComplete:frame4})

}

function frame4(){
  TweenMax.to("#FF #ff_txt1", .5, { left: 12, opacity:1, delay:8.4})
  TweenMax.to("#expanded-banner #FF #ff_txt2", .7, { left: 12, opacity:1, delay:8.5})
  
  
  TweenMax.from("#FF #footer", 1, { top:460, delay:8.7, ease:Strong.easeOut})   
}
