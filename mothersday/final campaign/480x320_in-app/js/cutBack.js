...
(function(window, undefined){
    ...
    var doubleClickEvents = {
        ...
        orientationChange : function(){
            ...
            if(Enabler.getOrientation().getMode() == "landscape"){
                orientationNumber = 0;
